...
export default function Navbar() {
    ...
    return (
        <nav className="bg-background dark:bg-background sticky w-full z-20 top-0 start-0">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between md:mx-3 mx-2 p-4">
                <Logo />
